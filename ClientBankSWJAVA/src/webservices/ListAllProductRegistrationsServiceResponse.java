 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://webServices/}productRegistration" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ListAllProductRegistrationsServiceResponse {
     ...
     *
     */
    public List<ProductRegistration> getReturn() {
        if (_return == null) {
            _return = new ArrayList<ProductRegistration>();
        }
        return this._return;
    }
