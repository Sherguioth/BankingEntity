...
# Form implementation generated from reading ui file 'GUIUpdateProductRegistration.ui'
#
...
class Ui_GUI_Update_Product_Registration(object):
    def setupUi(self, GUI_Update_Product_Registration):
        GUI_Update_Product_Registration.setObjectName("GUI_Update_Product_Registration")
        GUI_Update_Product_Registration.resize(575, 360)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(GUI_Update_Product_Registration.sizePolicy().hasHeightForWidth())
        GUI_Update_Product_Registration.setSizePolicy(sizePolicy)
        self.centralwidget = QtWidgets.QWidget(GUI_Update_Product_Registration)
        ...
        self.btn_update_product_registration = QtWidgets.QPushButton(self.centralwidget)
        self.btn_update_product_registration.setGeometry(QtCore.QRect(180, 290, 221, 41))
        font = QtGui.QFont()
        font.setFamily("Lucida Handwriting")
        font.setPointSize(14)
        self.btn_update_product_registration.setFont(font)
        self.btn_update_product_registration.setObjectName("btn_update_product_registration")
        ...
        GUI_Update_Product_Registration.setCentralWidget(self.centralwidget)
    ...
    def retranslateUi(self, GUI_Update_Product_Registration):
        _translate = QtCore.QCoreApplication.translate
        GUI_Update_Product_Registration.setWindowTitle(_translate("GUI_Update_Product_Registration", "Actualizar registro"))
        self.label_client_id_2.setText(_translate("GUI_Update_Product_Registration", "Documento del cliente:"))
        self.label_product_code_2.setText(_translate("GUI_Update_Product_Registration", "Producto:"))
        self.label_product_number_2.setText(_translate("GUI_Update_Product_Registration", "Número de producto:"))
        self.label_balance_2.setText(_translate("GUI_Update_Product_Registration", "Saldo:"))
        self.label_registration_date_2.setText(_translate("GUI_Update_Product_Registration", "Fecha de expedición:"))
        self.label_expiration_date_2.setText(_translate("GUI_Update_Product_Registration", "Fecha de vencimiento:"))
        self.label_state_2.setText(_translate("GUI_Update_Product_Registration", "Estado:"))
        self.btn_update_product_registration.setText(_translate("GUI_Update_Product_Registration", "Actualizar registro"))
        self.label_title.setText(_translate("GUI_Update_Product_Registration", "Actualizar producto"))
        self.btn_find_client.setText(_translate("GUI_Update_Product_Registration", "..."))
